...
#    $ sh ./split_data.sh -o /home/user/datasetoriginal -s ../datasetsplit -t 80 -v 10 -e 10
#
...
dir_valid=${split_dataset_path}"/valid"
...
do
    ...
    do
        ...
        if [[ $counter -gt $quantity_files_train && $counter -le $quantity_files_test ]]; then
            mv $dir_train/$dir_class/$file $dir_valid/$dir_class/$file
        fi
